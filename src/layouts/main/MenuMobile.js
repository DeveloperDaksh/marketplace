      ...
      >
        <Scrollbar>
          ...
          <List disablePadding>
            ...
            <ListItem>
              <RouterLink style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }} to="/register">
                <AccountCircle />
                Register
              </RouterLink>
            </ListItem>
            <ListItem>
              <RouterLink style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }} to="/login">
                <LoginIcon />
                Login
              </RouterLink>
            </ListItem>
